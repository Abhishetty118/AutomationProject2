...
public class RegisterUserWithExistingemail {
	...
	WebElement button;
	//div[@class="signup-form"]/form/input[4]
	@FindBy(xpath = "	//div[@class=\"signup-form\"]/form/input[4]")
	...
	public boolean VerifyEmailAlredyExistText() throws InterruptedException {
		Thread.sleep(2000);
